...
Supports downloading from Google Drive folders (max 100 files per folder).


## Installation

```bash
pip3 install git+https://github.com/Chitranjan6G/gdl

# to upgrade
pip install --upgrade git+https://github.com/Chitranjan6G/gdl
```
